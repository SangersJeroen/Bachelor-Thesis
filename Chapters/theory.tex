...
\begin{minipage}{0.48\textwidth}
	...
	\includegraphics[width=0.5\linewidth, keepaspectratio]{inse.png}
	\captionof{figure}{The crystal lattice of $\gamma$-InSe. The basis vectors are displayed as the blue arrows and a unit cell is outlined by the dashed blue box.}
	\label{fig:inse}
\end{minipage}%
\begin{minipage}{0.48\textwidth}
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.5\linewidth, keepaspectratio]{unit-cell.png}
	\captionof{figure}{A reciprocal unit cell containing the high-symmetry $\Gamma$-, $M$- and $K$-points. The reciprocal lattice vectors are denoted by the $\vec{b_1}$ and $\vec{b_2}$ vectors.}
	\label{fig:unit-cell}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.5\linewidth, keepaspectratio]{scat.png}
	\captionof{figure}{The elastic scattering $k'$ of an electron over an angle $\theta$ due to the interaction with a crystalline sample.}
	\label{fig:scat}
\end{minipage}%
\begin{minipage}{0.48\textwidth}
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.5\linewidth, keepaspectratio]{bands.png}
	\captionof{figure}{The band structure of the crystalline sample in fig. \ref{fig:scat} showing both a direct bandgap $t_1$ and an indirect bandgap $t_2$.}
	\label{fig:bands}
\end{minipage}
...
\begin{figure}
	\centering
	\includegraphics[width=0.35\linewidth, keepaspectratio]{filter.png}
...
\begin{minipage}{.45\textwidth}
	...
	\captionof{figure}{A q-EELS spectrum of $\gamma$-InSe for $q_{\perp}=0$}
	\label{fig:spectrum}
\end{minipage}%
\begin{minipage}{.45\textwidth}
	\centering
	...
	\captionof{figure}{A q-EELS map of $\gamma$-InSe along $\Gamma \rightarrow M \rightarrow K$}
	\label{fig:qmap}
\end{minipage}
