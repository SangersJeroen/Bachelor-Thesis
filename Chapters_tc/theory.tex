...
\begin{figure}[H]
	...
	\includegraphics[width=0.7\linewidth, keepaspectratio]{tem.png}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.75\linewidth, keepaspectratio]{filter.png}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.6\linewidth, keepaspectratio]{inse.png}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.6\linewidth, keepaspectratio]{unit-cell.png}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.6\linewidth, keepaspectratio]{scat.png}
...
\begin{figure}[H]
	\centering
	\captionsetup{width=0.9\linewidth}
	\includegraphics[width=0.6\linewidth, keepaspectratio]{bands.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\linewidth, keepaspectratio]{diff-im.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth, keepaspectratio]{tr-diff-im.png}
